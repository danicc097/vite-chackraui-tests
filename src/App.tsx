...
// no code should go outside -> Error
//

export const App = () => {
  const bg = useColorModeValue('#F1F1F1', 'red');
  ...
  return (
    <>
      ...
      <ChakraProvider theme={theme}>
        ...
        <Box backgroundColor={bg} borderRadius="lg" boxShadow="sm" pl={3} pr={3} pt={5} pb={5}>
          <Flex display="flex" flexDirection="column" alignItems="flex-start" justifyContent="flex-start" mb={2} pl={4}>
            P
          ...
          <Stack spacing={5} pl={4} pt={4}>
            ...
            <Stack>
              ...
              <Text color="gray.600">
                Toggle the code panel for viewing the JSX/React code of your components. You can even export your code
                directly to CodeSandbox!
              </Text>
            </Stack>
            <Stack spacing={4}>
              <Tag size="md" variant="solid" colorScheme="facebook">
